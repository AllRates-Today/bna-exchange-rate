// National Bank of Angola exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bna';
...
/** Latest rate for one pair, e.g. getRate('USD', 'AOA', { apiKey }). */
